export interface productInfo {
    ...
    nutritionInfo: {
        ...
        manufacturingAllergens: allergenList[],
    },
...
"8801043014809": {
    ...
    nutritionInfo: {
        ...
        manufacturingAllergens: ['우유', '메밀', '땅콩', '고등어', '게', '새우', '토마토', '호두', '닭고기', '오징어', '잣', '조개류'],
    },
    additionalInfo: {
        countryOfManufacture: "국산",
...
"8801047111849": {
    ...
    nutritionInfo: {
        ...
        manufacturingAllergens: ['쇠고기', '닭고기', '돼지고기', '우유', '호두', '토마토', '대두', '밀', '게', '조개류'],
    },
    additionalInfo: {
        countryOfManufacture: "국산",
...
"8809813750322": {
    ...
    nutritionInfo: {
        ...
        allergens: ['계란', '우유', '대두', '밀', '돼지고기', '닭고기', '쇠고기'],
        manufacturingAllergens: ['메밀', '땅콩', '게', '새우', '복숭아', '토마토', '오징어', '조개류'],
    },
    additionalInfo: {
        countryOfManufacture: "국산",
        recyclingInstructions: "비닐류",
...
"270003885995021401": {
    ...
    nutritionInfo: {
        ...
        allergens: ['대두', '밀', '새우', '돼지고기', '닭고기', '쇠고기', '조개류'],
        manufacturingAllergens: ['계란', '메밀', '땅콩', '고등어', '게', '복숭아', '토마토', '아황산류', '호두', '오징어', '조개류', '잣'],
    },
    additionalInfo: {
        countryOfManufacture: "국산",
        recyclingInstructions: "비닐류",
...
"8801117694906": {
    ...
    nutritionInfo: {
        ...
        allergens: ['밀', '우유', '대두'],
        manufacturingAllergens: ['계란', '땅콩', '호두', '복숭아', '토마토', '돼지고기', '쇠고기', '닭고기', '오징어', '새우', '게', '고등어', '조개류'],
    },
    additionalInfo: {
        countryOfManufacture: "국산",
        recyclingInstructions: "비닐류",
...
"8801043071253" : {
    ...
    nutritionInfo: {
        ...
        allergens: ['대두', '밀', '우유', '쇠고기', '새우'],
        manufacturingAllergens: ['계란', '땅콩', '잣', '게', '오징어', '돼지고기', '토마토', '닭고기', '조개류'],
    },
    additionalInfo: {
        countryOfManufacture: "국산",
        recyclingInstructions: "비닐류",
...
"8801128503211": {
    ...
    nutritionInfo: {
        ...
        allergens: ['계란', '우유', '대두', '밀', '돼지고기', '닭고기', '쇠고기', '오징어'],
        manufacturingAllergens: ['메밀', '땅콩', '게', '새우', '복숭아', '토마토', '조개류'],
    },
    additionalInfo: {
        countryOfManufacture: "국산",
